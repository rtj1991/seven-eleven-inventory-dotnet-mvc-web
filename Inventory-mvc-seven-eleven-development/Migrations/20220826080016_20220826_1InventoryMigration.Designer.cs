...
namespace Inventory_mvc_seven_eleven.Migrations
{
    ...
    [Migration("20220826080016_20220826_1InventoryMigration")]
    partial class _20220826_1InventoryMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory_mvc_seven_eleven.Models.InvoiceDetails", b =>
                {
                    ...
                    b.Property<int?>("Invoice_NoInvoiceNo")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Invoice_NoInvoiceNo");
            ...
            modelBuilder.Entity("Inventory_mvc_seven_eleven.Models.InvoiceHeader", b =>
                {
                    ...
                    b.Property<int?>("ILocIdId")
                        .HasColumnType("integer");

                    b.Property<string>("InCreatedById")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Inventory_mvc_seven_eleven.Models.InvoiceDetails", b =>
                {
                    b.HasOne("Inventory_mvc_seven_eleven.Models.InvoiceHeader", "Invoice_No")
                        .WithMany("Invoice_No")
                        .HasForeignKey("Invoice_NoInvoiceNo");

                    b.HasOne("Inventory_mvc_seven_eleven.Models.Item", "ItemCode")
                        .WithMany()
                        .HasForeignKey("ItemCodeId");

                    b.Navigation("Invoice_No");
            ...
            modelBuilder.Entity("Inventory_mvc_seven_eleven.Models.InvoiceHeader", b =>
                {
                    b.HasOne("Inventory_mvc_seven_eleven.Models.Location", "ILocId")
                        .WithMany()
                        .HasForeignKey("ILocIdId");

                    b.HasOne("Inventory_mvc_seven_eleven.Models.User", "InCreatedBy")
                        .WithMany()
                        .HasForeignKey("InCreatedById");

                    b.Navigation("ILocId");

                    b.Navigation("InCreatedBy");
                });
